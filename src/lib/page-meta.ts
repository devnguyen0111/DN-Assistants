...
const PAGE_META: Record<AppRoute, { title: keyof Dictionary; desc: keyof Dictionary }> = {
  ...
  habits: { title: "pageTitleHabits", desc: "pageDescHabits" },
  snippets: { title: "pageTitleSnippets", desc: "pageDescSnippets" },
  colors: { title: "pageTitleColors", desc: "pageDescColors" },
  filetools: { title: "pageTitleFileTools", desc: "pageDescFileTools" },
